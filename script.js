...
const translations = {
    en: {
        ...
        // Prospects
        "prospects.title": "Elite African Prospects",
    ...
    es: {
        ...
        "nav.recruit": "Reclutar Ahora",
        
        // Hero
        "hero.title": "La Principal Puerta de Entrada a las Futuras Estrellas del Baloncesto Africano.",
        "hero.description": "Informes de scouting verificados y videos de partidos curados sobre el talento africano emergente – diseñado para entrenadores que no quieren perder al próximo gran recluta.",
        "hero.cta": "Obtener Acceso al Scouting",
        
        // Trust Bar
        "trust.title": "CONFIADO POR ENTRENADORES EN TODO EL MUNDO",
        "trust.fiba": "LICENCIA FIBA",
        "trust.elite": "ACADEMIA ÉLITE",
        "trust.pro": "RED DE SCOUTS PRO",
        
        // About
        "about.title": "Quiénes Somos",
        "about.description1": "Meta Africa Sports tiene la misión de traerte lo mejor del baloncesto africano conectando el talento local con programas internacionales a través de una plataforma de scouting premium. Nos esforzamos por cerrar la brecha de información entre jugadores poco descubiertos y los equipos que los necesitan.",
        "about.description2": "Fundada por agentes licenciados por la FIBA y scouts experimentados, proporcionamos los datos verificados y videos de alta calidad necesarios para que los reclutadores tomen decisiones con confianza sobre las estrellas emergentes de África.",
        
        // Challenge
        "challenge.title": "El Desafío del Talento Africano",
        "challenge.problem1": "Los viajes de scouting son costosos, logísticamente complejos y de alto riesgo.",
        ...
        "challenge.solution2": "<strong>Videos Curados:</strong> Ahorra horas con clips HD enfocados en habilidades en lugar de mixtapes sin editar.",
        "challenge.solution3": "<strong>Alcance Panafricano:</strong> Accede a docenas de países a través de una base de datos central y élite.",
        
        // Features
        "features.title": "Diseñado para Tomadores de Decisiones Serios",
        "features.reports.title": "Informes de Scouting Verificados",
        "features.reports.description": "Evaluaciones en profundidad por scouts certificados por la FIBA. Obtén desgloses de habilidades, medidas y proyecciones de rol calibradas a estándares internacionales.",
        "features.film.title": "Videos de Partidos Curados",
        "features.film.description": "Highlights HD curados de partidos completos. Sin videos musicales—solo secuencias puras de baloncesto que validan la evaluación del scout.",
        "features.database.title": "Base de Datos Panafricana",
        "features.database.description": "Descubre la próxima estrella desde Nigeria hasta Senegal y Angola. Descubrimos a los prospectos antes de que lleguen a los circuitos principales.",
        
        // Prospects
        "prospects.title": "Prospectos Africanos de Élite",
    ...
    fr: {
        ...
        // Hero
        "hero.title": "La Porte d'Entrée Principale vers les Futures Stars du Basketball Africain.",
        "hero.description": "Rapports de scouting vérifiés et vidéos de matchs sélectionnées sur les talents africains émergents – conçu pour les entraîneurs qui refusent de manquer la prochaine grande recrue.",
        "hero.cta": "Obtenir l'Accès au Scouting",
        
        // Trust Bar
        "trust.title": "APPROUVÉ PAR LES ENTRAÎNEURS DU MONDE ENTIER",
        "trust.fiba": "LICENCE FIBA",
        "trust.elite": "ACADÉMIE ÉLITE",
        "trust.pro": "RÉSEAU DE SCOUTS PRO",
        
        // About
        "about.title": "Qui Sommes-Nous",
        "about.description1": "Meta Africa Sports a pour mission de vous apporter le meilleur du basketball africain en connectant les talents locaux aux programmes internationaux via une plateforme de scouting premium. Nous nous efforçons de combler le fossé d'information entre les joueurs sous-découverts et les équipes qui en ont besoin.",
        "about.description2": "Fondée par des agents licenciés FIBA et des scouts expérimentés, nous fournissons les données vérifiées et les vidéos de haute qualité nécessaires pour que les recruteurs prennent des décisions en toute confiance sur les étoiles montantes d'Afrique.",
        
        // Challenge
        "challenge.title": "Le Défi du Talent Africain",
        "challenge.problem1": "Les voyages de scouting sont coûteux, logistiquement complexes et à haut risque.",
        "challenge.problem2": "Les données fiables et vérifiées sur les prospects internationaux sont presque impossibles à trouver.",
        "challenge.problem3": "Les talents d'élite restent cachés dans des villages reculés faute de visibilité professionnelle.",
        ...
        "challenge.solution2": "<strong>Vidéos Sélectionnées :</strong> Gagnez des heures avec des clips HD axés sur les compétences au lieu de mixtapes brutes.",
        ...
        "features.film.title": "Vidéos de Matchs Sélectionnées",
        ...
        // Prospects
        "prospects.title": "Prospects Africains d'Élite",
        ...
        "success.testimonial": "\"Meta Africa Sports est la ressource que j'aurais aimé avoir il y a des années. C'est comme avoir des yeux experts sur le terrain dans chaque point chaud africain. Les rapports de scouting sont précis et nous font gagner des semaines de voyage.\"",
        ...
        "privacy.description1": "Chez Meta Africa Sports, votre confidentialité est primordiale. Nous traitons toutes les données de scouting et les informations personnelles avec le plus haut niveau de sécurité et en conformité avec les normes internationales de protection des données. Nous ne partageons les informations de scouting vérifiées qu'avec les recruteurs et partenaires autorisés pour faciliter la découverte de talents.",
        ...
        // Footer
        "footer.description": "Combler le fossé entre le talent émergent du basketball africain et la scène mondiale.",
        "footer.platform": "Plateforme",
        "footer.playerDatabase": "Base de Données des Joueurs",
...
function setLanguage(lang) {
    ...
    // Update dropdown button to show selected language
    const dropdownBtn = document.getElementById('lang-dropdown-btn');
    if (dropdownBtn) {
        dropdownBtn.querySelector('.lang-flag').textContent = langFlags[lang];
        dropdownBtn.querySelector('.lang-code').textContent = langCodes[lang];
    }
