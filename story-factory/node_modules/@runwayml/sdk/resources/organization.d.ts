...
export interface OrganizationRetrieveUsageResponse {
     ...
     */
    models: Array<'gen3a_turbo' | 'gen4_turbo' | 'gen4_image' | 'gen4_image_turbo' | 'upscale_v1' | 'act_two' | 'gen4_aleph' | 'veo3' | 'veo3.1' | 'veo3.1_fast' | 'gemini_2.5_flash' | 'eleven_multilingual_v2' | 'eleven_text_to_sound_v2' | 'eleven_voice_isolation' | 'eleven_voice_dubbing' | 'eleven_multilingual_sts_v2'>;
...
export declare namespace OrganizationRetrieveUsageResponse {
    ...
    namespace Result {
        interface UsedCredit {
             ...
             */
            model: 'gen3a_turbo' | 'gen4_turbo' | 'gen4_image' | 'gen4_image_turbo' | 'upscale_v1' | 'act_two' | 'gen4_aleph' | 'veo3' | 'veo3.1' | 'veo3.1_fast' | 'gemini_2.5_flash' | 'eleven_multilingual_v2' | 'eleven_text_to_sound_v2' | 'eleven_voice_isolation' | 'eleven_voice_dubbing' | 'eleven_multilingual_sts_v2';
        }
    }
}
